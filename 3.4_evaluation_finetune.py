...
nom_base = "Qwen/Qwen2.5-1.5B-Instruct"
tokenizer = AutoTokenizer.from_pretrained(nom_base)
model_base = AutoModelForCausalLM.from_pretrained(nom_base)

print("Chargement des adaptateurs LoRA fine-tunes...")
model = PeftModel.from_pretrained(model_base, "./modele_finetune_posologie")
print("Modele fine-tune pret.")
